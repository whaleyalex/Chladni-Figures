...
float ch126theta = 0.0; //start angle at 0
...
float ch126colNoise = 0.1; //color noise
...
void ch126CalcWave() {
  ch126theta -= 0.02; //incrememnt theta for different values of 'angular velocity'
  //ch126theta = 0.0; //noMovement\
...
void ch126RenderWave() {
  ...
  float col = map(noise(ch126colNoise), 0, 1, 0, 360);

...
float ch141theta = 0.0; //Start angle at zero
...
void ch141CalcWave() {
  ch141theta -= 0.02; //angular velocity
  //ch141theta = 0.0; //no movement
...
void ch141RenderWave() {  
  ...
  float col = map(noise(ch141colNoise), 0, 1, 240, 360);

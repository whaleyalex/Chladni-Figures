...
float ch137theta = 0.0; //start angle at 0
...
float ch137colNoise = 0.1; //color noise
...
void ch137CalcWave() {
  //ch137theta += 0.02; //incrememnt theta for different values of 'angular velocity'
  ch137theta = 0.0; //noMovement\
...
void ch137RenderWave() {
  ...
  float col = map(noise(ch137colNoise), 0, 1, 0, 360);
